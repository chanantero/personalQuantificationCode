function [absoluteTreeScheme, dataTree] = getTreeAbsoluteScheme( tree, dataRelativePaths )
...
for c = 1:numChildren
    [numberSchemeChild{c}, dataTreeChildren{c}] = getTreeAbsoluteScheme(tree.Children(c), dataRelativePaths(2:end));
end
