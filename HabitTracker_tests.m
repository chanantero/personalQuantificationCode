classdef HabitTracker_tests < matlab.unittest.TestCase
    ...
    methods(Test)
        function should_not_modify_xml_file_when_no_registers_are_added(testCase)
            % Given
            ...
            % When
            new_habits_table = [];
            HabitTracker.habitTable2XML(new_habits_table, HabitTracker_tests.habit_xml_file);
        ...
        function should_add_a_new_register(testCase)
            % Given
            xml_existing_text = sprintf(['%s\n',...
            '<global>\n',...
            '   <day date="21/07/2018">\n',...
            ...
            '       <element tag="Ejercicio">0</element>\n',...
            '       <element tag="Gratitud y Evidence Log">0</element>\n',...
            '       <element tag="Intención escrita">1</element>\n',...
            '       <element tag="Meditacion matutina">1</element>\n',...
            '       <element tag="Meditacion vespertina">0</element>\n',...
            '       <element tag="Planificacion matinal">1</element>\n',...
            '   </day>\n',...
            ...
            new_registers_table = table(...
             [datetime([2018, 7, 22]), datetime([2018, 7, 23]), datetime([2018, 7, 23])]',...
              {'Lalala', 'Habit B', 'Habit A'}',...
              {'Lololo', 'Valor B', 'Valor A'}',...
              'VariableNames', {'Date', 'Habit', 'Value'});

            expected_xml_text = sprintf(['%s\n',...
            '<global>\n',...
            '   <day date="23/07/2018">\n',...
            '      <element tag="Habit B">Valor B</element>\n',...
            '      <element tag="Habit A">Valor A</element>\n',...
            '   </day>\n',...
            '   <day date="22/07/2018">\n',...
            '      <element tag="Lalala">Lololo</element>\n',...
            '   </day>\n',...
            '   <day date="21/07/2018">\n',...
            '      <element tag="Cold Approach">1</element>\n',...
            '      <element tag="Ejercicio">0</element>\n',...
            ...
            '      <element tag="Planificacion matinal">1</element>\n',...
            '   </day>\n',...
            '</global>'], HabitTracker_tests.xml_file_heading);

            % When
            HabitTracker.habitTable2XML(new_registers_table, HabitTracker_tests.habit_xml_file);

            % Then
            xml_text = fileread(HabitTracker_tests.habit_xml_file);
            testCase.assertEqual(xml_text, expected_xml_text);
        end
    end
end